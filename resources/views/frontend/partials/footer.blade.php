<footer>
   ...
   <section class="it-footer-wrap it-footer-style-2 fix">
      <div class="it-footer-area z-index-1 pt-200 pb-80" data-background="{{ asset('assets/img/shape/footer-bg-3-1.jpg') }}">
         <img class="it-footer-shape-1 d-none d-xxl-block" src="{{ asset('assets/img/shape/footer-3-1.png') }}" alt="">
         <img class="it-footer-shape-2" src="{{ asset('assets/img/shape/footer-3-2.png') }}" alt="">
               ...
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 mb-50 wow itfadeUp" data-wow-duration=".9s"
                  ...
                  <div class="it-footer-widget it-footer-col-1-1">
                     <div class="it-footer-widget-logo mb-30">
                        <a href="{{ route('frontend.home') }}"><img src="{{ $siteSetting->footer_logo_url }}" alt=""></a>
                     </div>
